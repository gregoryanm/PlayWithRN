...
const images = {
  ...
  launch: require('../Images/LogoNoText.png'),
  logotext: require('../Images/coupleup_logo.png'),
  ready: require('../Images/CoupledUp.png'),
  ignite: require('../Images/ignite_logo.png'),
  igniteClear: require('../Images/ignite-logo-transparent.png'),
  tileBg: require('../Images/tile_bg.png'),
  background: require('../Images/BGMain.png'),
  buttonBackground: require('../Images/button-bg.png'),
  buttonBackgroundPurple: require('../Images/button-bg-purple.png'),
  ...
  registration: require('../Images/Registration.png'),
  resetaccount: require('../Images/ResetAccount.png'),
