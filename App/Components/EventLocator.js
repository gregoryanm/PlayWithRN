...
import EventLocatorCallout from './EventLocatorCallout'
import Styles from './Styles/EventLocatorStyles'
...
class EventLocator extends React.Component {
  /* ***********************************************************
  ...
  *************************************************************/
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./EventLocatorCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <EventLocatorCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
